...
# This script uses the GO enrichment results fron the script 'go_enrichment.R' to plot figure 3.  Its input also includes the file
...
{
  Ontologizer.table=read.table(paste0('GO enrichment covid19/table-',dataset,'_de-Term-For-Term-Benjamini-Hochberg.txt'),header=TRUE)
